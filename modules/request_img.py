...
# r = requests.get("https://muzma.net/20336-pesnya-devochka-vensdej-s-poslednej-party.html")
# soup = bs4.BeautifulSoup(r.content, "lxml")
# for link in soup.select("img[src^=http]"):
#         lnk = link["src"]
#         img_path = os.path.join(os.path.abspath(__file__ +"/.."), "image1.png")
#         with open(img_path, 'wb') as img:
#             img.write(requests.get(lnk).content)
